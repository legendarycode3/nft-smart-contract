...
* **`README.md`**: Provides documentation for the project, including its architecture, features, smart contracts, functions, installation, usage, testing, security considerations, and
