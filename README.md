...
MoodNft Contract
  ...
  Generate JSON Metadata
     ...
     Data URI Returned
```
The deployment script reads the Happy and Sad SVG files from the repository and converts them into Base64-encoded image Data URIs before passing them to the
