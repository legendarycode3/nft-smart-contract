...
* **External Storage Dependency**:  Although ownership records are stored securely on-chain, the associated images and metadata are maintained off-chain through IPFS.
