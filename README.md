...
* **Metadata Integrity**: The contract assumes that all metadata files were correctly created, uploaded, and linked before deployment. Invalid JSON formatting, broken IPFS links, or incorrect image references will result in incomplete or
