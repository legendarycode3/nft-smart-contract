...
* **Minimal External Surface Area**: The contracts expose only the functions necessary for minting NFTs, retrieving metadata, and updating NFT moods. Keeping the public interface small reduces the overall attack surface and
