...
* **Gas Consumption of `tokenURI()`**:  Although `tokenURI()` is normally called as a read-only operation, applications interacting with the function on-chain or through other contracts may incur additional computational
