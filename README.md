...
* **`foundry.toml`**: The main Foundry configuration file. It defines project settings such as source directories, test directories, library paths,  compiler configuration, and    
