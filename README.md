...
* **Lightweight Contract Architecture**: Each contract focuses on a single responsibility—either managing traditional NFTs or dynamic NFTs. This modular design keeps contract logic compact, reducing deployment size and 
