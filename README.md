...
## Architecture
The project follows a modular architecture that separates NFT logic, deployment automation,  contract interactions, and This separation improves maintainability, readability, and extensibility
