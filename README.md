...
```shell
          ...
          IPFS Metadata                   Generate Metadata
                                           ...
                                           Base64 Encode
                                            ...
                                            Data URI
```
Together, these workflows demonstrate two major approaches to NFT metadata architecture: **`off-chain metadata using IPFS`** and **fully on-chain dynamic metadata using Base64-encoded JSON and SVG artwork**.
