...
After deployment, the artwork is stored within the contract and reused whenever metadata is generated. This removes the need for an external metadata server
