...
* **External Storage Dependency**:  Although ownership records are stored securely on-chain, the associated images and metadata are maintained off-chain through IPFS. The long-term availability of these assets depends on maintaining
