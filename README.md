...
* **Custom Errors**: The `MoodNft` contract uses custom Solidity errors instead of revert strings for access control validation. This reduces deployment bytecode size and
